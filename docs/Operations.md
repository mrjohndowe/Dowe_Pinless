...
The service and clients use the version-2 local pipe with caller-token SID binding; an
interactive caller cannot claim another account or the LocalSystem SID.
