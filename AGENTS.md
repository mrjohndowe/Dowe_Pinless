...
* every PowerShell command block provided will include an extra blank line after the final command—effectively an additional Enter at the end—so the last command is ready to execute when pasted

- Do not push anything straight to the repository
- If you are giving me commands to create a branch, then give me commands to merge then as well
